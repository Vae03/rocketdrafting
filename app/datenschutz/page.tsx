...
export default function DatenschutzPage() {
  return <LegalPage title="Datenschutzerklärung">
    ...
    <p>Wenn du das Kontaktformular nutzt, speichern wir die von dir angegebene E-Mail-Adresse sowie deine Nachricht, um deine Anfrage zu beantworten. Diese Daten werden ausschließlich zur Bearbeitung deiner Anfrage verwendet.</p>
    ...
    <p>Es findet keine Weitergabe deiner Daten an Dritte zu Werbezwecken statt. Historische RLCS-Daten werden von Liquipedia bezogen (siehe Impressum); dabei werden keine personenbezogenen Daten von dir an Liquipedia übermittelt.</p>
